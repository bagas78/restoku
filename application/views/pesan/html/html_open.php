...
<html>
	...
	<script src="<?php echo base_url('asset/js/cookie.js'); ?>"></script>
		...
		<script type="text/javascript" src="<?php echo base_url('asset/new/datatables.min.css') ?>"></script>
		...
		<script src="<?php echo base_url('asset/js/civem.min.js');?>"></script>
	</head>
