	...
	<section class="content">
    	<div class="row">
			<div class="col-xs-9">
				<div class="box">
          			<div class="box-header">
            			<h3 class="box-title">Edit Data Minuman</h3>
          			...
          			<div class="box-body">
						<div class="row">
							<div class="col-sm-12"><br>
								<?php echo form_open_multipart('insertdata/update_minuman/'.$edit->id_menu); ?>
									...
									<input type="number" name="stok" style="width:100%;" required="" value="<?php echo $edit->stok_menu; ?>"/><br><br>
