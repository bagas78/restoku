...
<div class="content-wrapper">
							...
							<div class="col-md-6 col-md-offset-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										...
										<input type="text" name="end_date" value="" hidden>
	...
	<div class="box box-widget" id="chart">
        </div>
	</section>
</div>
...
$(document).ready(function() {
  ...
  $('#daterange_btn').daterangepicker(
      {
        ranges   : {
          '7 Hari Terahkir' : [moment().subtract(6, 'days'), moment()],
          '30 Hari Terahkir': [moment().subtract(29, 'days'), moment()],
          'Bulan ini'  : [moment().startOf('month'), moment().endOf('month')],
          'Bulan Terahkir'  : [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
        },
...
function createChart(e){
  ...
  e.preventDefault();
  $.ajax({
    url : "<?php echo base_url('grafik/createChart/') ?>" + start_date + "/" + end_date,
    dataType: "html",
