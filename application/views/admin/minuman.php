								...
								<table id="example" class="table table-striped table-bordered">
									...
									<tbody>
										...
										<tr role="row" class="even">
											...
											<td>
												<a href="<?php echo base_url('insertdata/edit_minuman/'.$data->id_menu); ?>">
												...
												<?php
													...
													echo anchor(site_url('Insertdata/hapus_minuman/' . $data->id_menu), ' ', $hapus);
												?>
											</td>
										</tr>
										<?php endforeach; ?>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Masukan Data Minuman</h4>
				</div>
				<div class="modal-body">
				<?php echo form_open_multipart('insertdata/tambah_aksi_minuman'); ?>
