...
<head>
  <meta charset="utf-8">
  <meta http-equiv="refresh" content="0; URL=<?php echo base_url('order/orderProses') ?>">
					...
					<table>
						<thead>
							...
							<tr>
								...
								<td style="width:100px;">: <?php echo $proses->no_transaksi; ?></td>
								<td style="width:100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pembeli</td>
								<td style="width:100px;">&nbsp;: <?php echo $proses->pembeli; ?></td>
							</tr>
							<?php endforeach; ?>
							<tr>
								<td>Meja</td>
					...
					<table class="table table-striped"  style="margin-bottom: 0px;">
						...
						<tfoot>
							...
							<tr>
								...
								<td align="center"><?php echo $this->fungsi->rupiah($value->bayar);?></td>
							</tr>
							<tr>
								<td colspan="5" align="right">
									<strong>Diskon</strong>
								</td>
								<td align="center"><?php echo $value->diskon;?></td>
							</tr>
							<tr>
								<td colspan="5" align="right">
									<strong>Kembalian</strong>
								</td>
								<td align="center"><?php echo $this->fungsi->rupiah($value->kembalian);?></td>
							</tr>
							<?php endforeach; ?>
						</tfoot>
				<div>---------------------------------------------------------------------------------------</div>
